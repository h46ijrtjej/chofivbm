...
const port = process.env.SERVER_PORT || process.env.PORT || 6900;        
const UUID = process.env.UUID || '309c0348-32e8-4924-a027-9a237ea85bca'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho5.b8kdhskh.eu.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiODc0MGJjYjg0OTdlMjE2NWFlNTJmY2E2NTk2NTU1ZjMiLCJ0IjoiMzQyNzlkM2YtYzY3NC00ZTM1LThjNjYtMTJiYThjZDY0MzA3IiwicyI6Ik9EazVaall6WmpZdFpUTXlZaTAwTjJZNUxXSXdZbU10WWpWbVlXVTNORFF4T0dJeSJ9';
